...
1- [Biomedical data analytics in mobile-health environments for high-risk pregnancy outcome prediction](https://link.springer.com/article/10.1007/s12652-019-01230-4)
...
2- [Maternal mortality of women with opioid-use during pregnancy in England:investigating bias in a cohort of linked mother-baby hospital records](https://ijpds.org/article/view/895)
...
3- [Association Between Vitamin D Supplementation During Pregnancy and Offspring Growth, Morbidity, and Mortality](https://jamanetwork.com/journals/jamapediatrics/article-abstract/2681636)
...
4- [Comparison of logistic regression with machine learning methods for the prediction of fetal growth abnormalities: a retrospective cohort study](https://bmcpregnancychildbirth.biomedcentral.com/articles/10.1186/s12884-018-1971-2)
...
5- Além dos artigos mencionados e e pesquisados, há pesquisas que indicam que é importante para os profissionais da área de epidemiologia mensurar os efeitos espaciais que atuam sobre eventos de saúde pública como mortalidade de gestantes e infantil. A abordagem determina a identificação de áreas com maior ou menor risco uma vez que é comprovado que a localização espacial dos eventos influencia a mortalidade. Duas boas referências são @shimakura2001distribuiccao e @barlettaTCC
  ...
  - [Distribuição espacial do risco: modelagem da mortalidade infantil em Porto Alegre, Rio Grande do Sul, Brasil](https://www.scielosp.org/article/csp/2001.v17n5/1251-1261/pt/)
...
6- Outra importante informação é a grande quantidade de estudos sobre mortalidade com a abordagem espacial por meio da Inferência Bayesiana. Muitos trabalhos publicados o que mostra a maior eficácia desta abordagem para a modelagem de mortalidade levando em consideração tempo e espaço em que os eventos ocorreram. Alguns autores publicaram estudos com tais abordagens, @krainski2018advanced, @khana2018bayesian, @loquiha2018mapping, @blangiardo2015spatial, @musenge2013bayesian.
  ...
  - [Advanced Spatial Modeling with Stochastic Partial Differential Equations Using R and INLA](https://www.taylorfrancis.com/books/9780429629853)
  
  - [A Bayesian spatial and temporal modeling approach to mapping geographic variation in mortality rates for subnational areas with R-INLA](A Bayesian spatial and temporal modeling approach to mapping geographic variation in mortality rates for subnational areas with R-INLA)
  
  - [Mapping maternal mortality rate via spatial zero-inflated models for count data: A case study of facility-based maternal deaths from Mozambique](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0202186) 
  
  - [Spatial and spatio-temporal Bayesian models with R-INLA](https://books.google.com.br/books?hl=en&lr=&id=--HuBgAAQBAJ&oi=fnd&pg=PA259&dq=Spatial+and+spatio-temporal+Bayesian+models+with+R-INLA&ots=VTEBD3sgRX&sig=2rfXYJJDy7qUNsJPRgUdGGV8WC8&redir_esc=y#v=onepage&q=Spatial%20and%20spatio-temporal%20Bayesian%20models%20with%20R-INLA&f=false)
  
  - [Bayesian analysis of zero inflated spatiotemporal HIV/TB child mortality data through the INLA and SPDE approaches: Applied to data observed between 1992 and 2010 in rural North East South Africa](https://www.sciencedirect.com/science/article/pii/S0303243412000645)
